...
public class EntryArea {
    ...
    private TelefonEntry telefonEntry = new TelefonEntry();
...
//        FilteredList<Object> observableList;
//        observableList.setPredicate(telefonEntry -> {
...
//        });
//        tableView.setItems(ObservableList<TelefonEntry>);
//    }
